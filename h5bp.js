        ...
        https.get(url, function(res){
            ...
            res.on("end", function(){
                fs.writeFile("./icon.png", imgurl1, "binary", function(err){
                    if(err){
                        console.log("icon.png生成失败");
                        process.exit(0);
                    }
                    console.log("icon.png生成成功");
                });
            });
        });
        ...
        https.get(url, function(res){
            ...
            res.on("end", function(){
                fs.writeFile("./tile-wide.png", imgurl2, "binary", function(err){
                    if(err){
                        console.log("tile-wide.png生成失败");
                        process.exit(0);
                    }
                    console.log("tile-wide.png生成成功");
                });
            });
        });
